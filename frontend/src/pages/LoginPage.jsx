    ...
    <div className="min-h-screen bg-[#08090D] text-[#F5F5F7] flex flex-col justify-between font-['Inter',sans-serif] relative overflow-hidden">
      ...
      <header className="px-6 py-6 max-w-7xl w-full mx-auto flex items-center justify-between relative z-10">
        <Link to="/" className="flex items-center space-x-3 group">
          <div className="h-10 px-2.5 py-1 rounded-xl bg-[#111319] border border-[#252832] flex items-center justify-center shadow-lg group-hover:border-[#7C3AED]/50 transition-all">
            <img src="/logo.png" alt="ORVIX" className="h-7 w-auto object-contain" />
          </div>
        </Link>
        <Link to="/signup" className="text-xs font-semibold text-[#8B5CF6] hover:text-[#A78BFA]">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
        <div className="w-full max-w-md bg-[#111319] border border-[#252832] p-8 rounded-3xl shadow-2xl space-y-6">
          <div className="text-center space-y-3">
            <div className="w-44 mx-auto p-3 bg-[#08090D] border border-[#252832] rounded-2xl shadow-xl">
              <img src="/logo.png" alt="ORVIX Logo" className="w-full h-auto object-contain" />
            </div>
            <h1 className="text-2xl font-bold font-['Outfit'] text-[#F5F5F7]">Welcome Back to ORVIX</h1>
            <p className="text-xs text-[#A1A1AA]">Sign in to access your revenue recovery control center.</p>
          </div>
          ...
          <div className="pt-2 text-center border-t border-[#252832]">
            <p className="text-[11px] text-[#71717A]">
              Demo Mode Active • Enter any email/password to sign in instantly.
            </p>
          </div>
        </div>
      </main>
